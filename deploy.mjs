...
const vaults = [
  {
    name: 'Mobile',
    path: join(BASE_PATH, '.obsidian-mobile/plugins/keyword-notes-editor')
  },
  {
    name: 'Pro',
    path: join(BASE_PATH, '.obsidian-pro/plugins/keyword-notes-editor')
  },
  {
    name: 'iPad',
    path: join(BASE_PATH, '.obsidian-ipad/plugins/keyword-notes-editor')
  },
  {
    name: '2017',
    path: join(BASE_PATH, '.obsidian-2017/plugins/keyword-notes-editor')
  },
  {
    name: 'Zhang',
    path: join(BASE_PATH, '.obsidian-zhang/plugins/keyword-notes-editor')
  },
  {
    name: 'Note-Demo',
    path: join(NOTE_DEMO_PATH, '.obsidian/plugins/keyword-notes-editor')
  }
];
...
console.log('🚀 开始部署 Keyword Notes Editor 插件...\n');
